...
enum {
    ...
    CmdToggleAudiobookVoices = 458,
    CmdAudiobookCharacters = 459,
    CmdToggleLibraryHome = 460,
    CmdLibraryRescan = 461,
    CmdDeleteFileAndOpenNext = 462,
    CmdShowGeneratedHTML = 463,
    CmdDeleteCachedFiles = 464,
    CmdToggleKeyboardLinkFollowing = 465,
    CmdDebugToggleDpiOverride = 466,
    CmdToggleImages = 467,
    CmdSelectTextViaKeyboard = 468,
    CmdOpenFileWithOSFilePicker = 469,
    CmdToggleFilePicker = 470,
    CmdToggleBoolSetting = 471,
    CmdFixDefaultApp = 472,
    CmdAIChatWithAntiGravity = 473,
    CmdTranslateSelectionWithAntiGravity = 474,
    CmdConvertToPDF = 475,
    CmdDebugShowFitContentArea = 476,
    CmdExtendSelectionCharLeft = 477,
    CmdExtendSelectionCharRight = 478,
    CmdExtendSelectionWordLeft = 479,
    CmdExtendSelectionWordRight = 480,
    CmdToggleLaserPointer = 481,
    CmdZoomToSelection = 482,
    CmdToggleHoverPreview = 483,
    CmdToggleDisableLinks = 484,
    CmdSignDocument = 485,
    CmdInsertImage = 486,
    CmdToggleHighlightFormFields = 487,
    CmdLibraryIndexing = 488,
    CmdNone = 489,
