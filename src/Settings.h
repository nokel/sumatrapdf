...
static StructInfo gFileStateInfo = {
    ...
    25,
    gFileStateFields,
    "FilePath\0Favorites\0IsPinned\0IsMissing\0OpenCount\0MaxPageReached\0TimeSpentMs\0LastReadAt\0DecryptionKey\0EBook"
    "UI\0UseDefaultState\0DisplayMode\0ScrollPos\0PageNo\0Zoom\0Rotation\0WindowState\0WindowPos\0ShowToc\0SidebarDx\0D"
    "isplayR2L\0BgCol\0TabCol\0ReparseIdx\0TocState",
    ...
    "considered missing and won't be shown in any list\0number of times this document has been opened "
    "recently\0furthest page reached in this document\0total time spent reading this document, in milliseconds\0when "
    "this document was last read, as unix time in milliseconds\0data required to open a password protected document "
    "without having to ask for the password again\0reflowable (ebook) settings for just this document. The block is "
    "absent until you add it; a field left empty or 0 uses the global EBookUI value. The global section's WindowBgCol "
    "and DefaultDisplayMode are already per-document as BgCol and DisplayMode below\0if true, this document opens with "
    "the global defaults instead of the values below\0layout of pages. valid values: automatic, single page, facing, "
    "book view, continuous, continuous facing, continuous book view\0how far this document has been scrolled (in x and "
    "y direction)\0number of the last read page\0zoom (in %) or one of those values: fit page, fit width, fit height, "
    ...
    "contents (Bookmarks) sidebar when the document has one\0width of the bookmarks / favorites sidebar in screen "
    "pixels, as last resized\0if true, the document is displayed right-to-left in facing and book view modes\0if "
    "given, overrides the background color for this document\0if given, overrides the tab color for this "
    "document\0data required to restore the last read page in the ebook UI\0data required to determine which parts of "
    "the table of contents have been expanded",
    false};
...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "MarkdownUI\0\0HtmlUI\0\0ClaudeCode\0\0Audiobook\0\0GrokBuild\0\0CodexBuild\0\0AntiGravity\0\0AIChatSidebarDx\0\0Tr"
    "anslateToLang\0TranslateFromLang\0TranslateEngine\0\0Annotations\0\0ExternalViewers\0\0ForwardSearch\0\0PrinterDef"
    "aults\0\0Fullscreen\0\0SelectionHandlers\0\0Shortcuts\0\0Themes\0\0TabGroups\0\0CustomScreenDPI\0\0\0DefaultPasswo"
    "rds\0UiLanguage\0VersionToSkip\0WindowState\0WindowPos\0SearchUIWindowPos\0FileStates\0SessionData\0ReopenOnce\0Ti"
    ...
    "browser view is used when available\0\0settings for the Claude Code chat sidebar\0\0settings for the Chatterbox "
    "audiobook Read Aloud engine\0\0settings for the Grok Build chat sidebar\0\0settings for the OpenAI Codex chat "
